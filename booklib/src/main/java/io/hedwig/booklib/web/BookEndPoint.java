...
import io.hedwig.booklib.service.book.BookService;
import io.hedwig.booklib.web.support.MediaTypes;
...
public class BookEndPoint {
    ...
    public void modifyBook(@RequestBody Book book, HttpSession session) {
        ...
        if (!owner.id.equals(book.owner.id)) {
            throw new RestException("User can't modify others book",
    ...
    public void deleteBook(@PathVariable("id") Long id, HttpSession session) {
        ...
        if (!owner.id.equals(book.owner.id)) {
            throw new RestException("User can't delete others book",
                    HttpStatus.FORBIDDEN);
        }
